    ...
    $.widget('pic.pnlCfgSpi', {
        ...
        _buildControls: function () {
            ...
            $.getLocalService('/config/options/spi/' + o.controllerId, null, function (data, status, xhr) {
                ...
                for (var i = 0; i < 32; i++) {
                    self.createAdcChannel(i).appendTo(channels);
                }
        ...
        createAdcChannel: function (channelId) {
            ...
            $('<div></div>').appendTo(line).pickList({
                ...
                items: o.analogDevices, inputAttrs: { style: { width: '20.7rem' } }, labelAttrs: { style: { marginLeft: '1rem' } }
            });
        ...
        setAdcChip: function (chipType) {
            ...
            if (typeof chipType === 'undefined') {
                ...
                var channels = el.find('div.pnl-adc-channels > div.picAccordian');
